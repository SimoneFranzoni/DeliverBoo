...
@section('dashboard-content')
  <div class="">
    ...
    <div style="margin:50px;">
      ...
      <h3 id="no-rest"class="card-team5 text-center text-danger">Non hai ancora registrato i tuoi ristoranti</h3>
    </div>
                ...
                class="plate-img col-3 p-0">
                  @if ($ristorante->cover)
                    ...
                    @if($ristorante->cover_up_by_user)
                      ...
                      border-radius: 15px;
                      overflow: hidden;
                      object-fit: cover;" class="img-restaurant" src="{{asset('storage/' . $ristorante->cover)}}" alt="{{$ristorante->name}}">
                    @else 
                      <img style="width: 100%;
                      height: 100%;
                      border-radius: 15px;
                      overflow: hidden;
                      object-fit: cover;" src="{{asset($ristorante->cover)}}" alt="{{$ristorante->name}}">
                    @endif
                  @else
      ...
      <div class="small-restaurant-slider-team5 d-md-none">
        @foreach ($ristoranti as $ristorante)
          <div class="">
            <div 
            class="card-team5">
              ...
              <div class="d-flex col-12 col-md-4 button-container-restautant">
                <a  href="{{route('admin.miei-ristoranti.edit', $ristorante->slug)}}">
                  <button class="btn-team5 ">Modifica</button>  
                </a>
                <form class="d-inline-block" onsubmit="return confirm('Confermi eliminazione ristorante: {{$ristorante->name}}')"
                  action="{{ route('admin.miei-ristoranti.destroy', $ristorante)}}" method="POST">
                      @csrf
